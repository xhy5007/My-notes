...
| **telnet-server** | 30       | 172.16.66.0/24 | 172.16.66.254/24 (手工)               | 172.16.66.1 (R1-0/0/1.3) |
...
| **设备**        | **VLAN** | **网段**               | **IP地址**                                        | **网关**                    |
| --------------- | -------- | ---------------------- | ------------------------------------------------- | --------------------------- |
| **DNS/client1** | 60       | 172.16.128.0/25        | DNS: 172.16.128.126/25 client1: 172.16.128.125/25 | 172.16.128.1 (R7-0/0/2.1)   |
| **PC5**         | 70       | 172.16.128.128/25      | 172.16.128.254/25                                 | 172.16.128.129 (R7-0/0/2.2) |
| **R3-R4**       | /        | 172.16.129.0/24 (1G)   | R3: 172.16.129.1/24 R4: 172.16.129.2/24           | /                           |
| **R3-R4**       | /        | 172.16.130.0/24 (100M) | R3: 172.16.130.1/24 R4: 172.16.130.2/24           | /                           |
...
| **设备** | **网段**     | **地址**             |
| -------- | ------------ | -------------------- |
| **R3**   | 100.0.0.0/24 | R3 G0/0/2: 100.0.0.1 |
| **test** | 100.0.0.0/24 | test IP: 100.0.0.2   |
